...
$dbc = @mysqli_connect ('localhost', 'payment', 'payment123', 'payment') OR die ('Could not connect to MySQL: ' . mysqli_connect_error() );
    ...
    $cangwei = null;
    foreach ($cangweis as $cangweiss){
       $cangwei= $cangwei . $cangweiss['classrate'].'/'.$cangweiss['class_price'].';';
    }
...
<div class="container" >
    ...
    <form method="post" action="do-update-flight.php" id="submit">
    <input type="text" hidden name="id" <?php echo 'value="' . $id . '"' ?>;>
        ...
        <div class="form-horizontal" id="form" style="padding-top: 20px">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control"  name="from" <?php echo 'value="' . $from .'"'?>>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" >到达地点</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control"   name="to" <?php echo 'value="' . $to .'"'?>>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control"   name="start" <?php echo 'value="' . $start .'"'?>>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" >到达时间</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control"   name="end" <?php echo 'value="' . $end .'"'?>>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" >舱位</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control"  name="cangwei" <?php echo 'value="' . $cangwei .'"'?>>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" >价格</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control"   name="price" <?php echo 'value="' . $price .'"'?>>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-4 col-sm-5">
                        <input type="submit" value="修改航班" class="button">
                    </div>
                </div>
                </div>
        </div>
